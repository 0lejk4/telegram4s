...
object InlineKeyboardButton {
  ...
  implicit val encoder: Encoder[InlineKeyboardButton] = deriveEncoder[InlineKeyboardButton]
  implicit val decoder: Decoder[InlineKeyboardButton] = deriveDecoder[InlineKeyboardButton]
}

...
case class InputTextMessageContent(messageText: String,
                                   ...
                                   disableWebPagePreview: Option[Boolean] = None) extends InputMessageContent
...
case class InputVenueMessageContent(latitude: Double,
                                    ...
                                    foursquareType: Option[String] = None) extends InputMessageContent
...
case class InputContactMessageContent(phoneNumber: String,
                                      ...
                                      vcard: Option[String] = None) extends InputMessageContent

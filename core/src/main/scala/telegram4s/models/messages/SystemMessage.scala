...
import telegram4s.models.{Chat, PhotoSize, SuccessfulPayment, User}
...
object ChatPhotoChanged {
  implicit val decoder: Decoder[ChatPhotoChanged] = deriveDecoder[ChatPhotoChanged]
}

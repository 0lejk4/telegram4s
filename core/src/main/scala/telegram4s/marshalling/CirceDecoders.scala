...
import telegram4s.methods.TelegramResponse
...
import telegram4s.models.{ParseMode, _}
...
trait CirceDecoders extends StrictLogging {
  ...
  implicit def templateResponseDecoder[T](implicit decT: Decoder[T]): Decoder[TelegramResponse[T]] = deriveDecoder[TelegramResponse[T]]

...
object PromoteChatMember {
  implicit val encoder: Encoder[PromoteChatMember] = deriveEncoder[PromoteChatMember]
  implicit val method: TelegramMethod[PromoteChatMember, Boolean] = TelegramMethod[PromoteChatMember, Boolean]("PromoteChatMember")
}

package telegram4s.methods.updates
...
object GetUpdates {
  implicit val encoder: Encoder[GetUpdates] = deriveEncoder[GetUpdates]
  implicit val method: TelegramMethod[GetUpdates, List[Update]] =
    TelegramMethod[GetUpdates, List[Update]]("GetUpdates")
  /**
